...
#define BOARD_CSWL_CONTROL_BOARD 	0  //STM32F10X_HD,HSE_VALUE=16000000
#define BOARD_VARES_CHARGER_BOARD 1  //STM32F10X_LD_VL,HSE_VALUE=0
...
#define BOARD_USING_USB 0
#define BOARD_USING_SYSTICK 1
#define BOARD_COMMON_SETUP_CLK  0
#define BOARD_PRIVATE_SETUP_CLK  0
