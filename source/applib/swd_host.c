...
reset_type_t swd_default_reset_type = kHardwareReset; //kSoftwareReset
...
{
		SWD_target_reset( asserted );
	//JK: for reset pin stablely
		//systick_delay_ms(1);
}
...
uint8_t swd_init_debug(void)
{
    ...
    do {
        ...
        // initing the debug
				// JK: disable specifical interface
...
{
	if ( swd_default_reset_type == kHardwareReset) {
...
{
	swd_default_reset_type = rstType;
}
